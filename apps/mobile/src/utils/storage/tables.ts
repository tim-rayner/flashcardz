...
export type TableName = 'decks' | 'cards' | 'sessions' | 'card_results' | 'settings';
...
export const TABLES = {
  ...
  cards: defineTable({
    name: 'cards',
    columns: ['id', 'deck_id', 'question', 'answer', 'notes', 'created_at'],
    keyColumns: ['id'],
  }),
  sessions: defineTable({
    name: 'sessions',
    columns: ['id', 'deck_id', 'started_at', 'completed_at'],
    keyColumns: ['id'],
  }),
